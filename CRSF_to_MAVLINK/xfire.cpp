...
uint32_t crossfireChannels[CROSSFIRE_CHANNELS_COUNT];  //populate this array with the channel data in the range defined in CROSSFIRE_LOW to CROSSFIRE_HIGH
double sensorGPSLat;
    ...
    case GPS_ID:
      ...
      if (getCrossfireTelemetryValue<2>(13, value)){
         if(crossfireDebug == 1){
          ...
          processCrossfireTelemetryValue(GPS_HEADING_INDEX, value / 10);
      }  
